...
class Campo extends JPanel { // Campo representa o mapa da arena, e cuida do output gráfico
    ...
    private void initTexturas(){
        ...
        try {
            grama = ImageIO.read(this.getClass().getResource("/img/grama3.png"));
        }
        catch (Exception e) {
            System.exit(1);
        }
        ...
        try {
            terra = ImageIO.read(this.getClass().getResource("/img/terra7.png"));
        }
        catch (Exception e) {
            System.exit(1);
        }
        ...
        try {
            baseB = ImageIO.read(this.getClass().getResource("/img/baseB.png"));
        }
        catch (Exception e) {
            System.exit(1);
        }
